...
//各层分类器数据
const string StaticData::cascadePath = "./haarcascades/cascades.xml";  //第一层：人头检测
const string StaticData::nestedCascadePath = "./haarcascades/haarcascade_frontalface_alt2.xml"; //正脸检测
const string StaticData::thirdCascadePath = "./haarcascades/haarcascade_mcs_nose.xml";  //鼻子检测
const string StaticData::forthCascadePath = "./haarcascades/haarcascade_mcs_mouth.xml";  //嘴巴检测
