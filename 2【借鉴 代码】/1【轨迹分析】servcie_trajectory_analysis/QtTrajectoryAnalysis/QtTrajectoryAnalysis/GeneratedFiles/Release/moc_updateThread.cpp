...
static const char qt_meta_stringdata_updateThread[] = {
    ...
    "sendFrameImg(cv::Mat*)\0getThreadEnd()\0"
};
...
void updateThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendFrameImg((*reinterpret_cast< cv::Mat*(*)>(_a[1]))); break;
        case 2: _t->getThreadEnd(); break;
        default: ;
        }
    }
}
...
// SIGNAL 1
void updateThread::sendFrameImg(cv::Mat * _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
