...
static const char qt_meta_stringdata_QtTrajectoryAnalysis[] = {
    ...
    "on_pBtn_Check_clicked()\0"
    "on_pBtn_Analysis_clicked()\0"
    "on_pBtn_quit_clicked()\0updateProcessBar(int)\0"
    "getThreadEnd(cv::Mat*)\0getThreadStop()\0"
    "getThreadFail()\0getFrameImg(cv::Mat*)\0"
    "AnalyzeThreadEnd(cv::Mat*)\0"
    "AnalyzeThreadFail()\0closeWaitDlg()\0"
    "batchDone()\0"
};
...
void QtTrajectoryAnalysis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_pBtn_OutputFolder_clicked(); break;
        case 2: _t->on_pBtn_Check_clicked(); break;
        case 3: _t->on_pBtn_Analysis_clicked(); break;
        case 4: _t->on_pBtn_quit_clicked(); break;
        case 5: _t->updateProcessBar((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->getThreadEnd((*reinterpret_cast< cv::Mat*(*)>(_a[1]))); break;
        case 7: _t->getThreadStop(); break;
        case 8: _t->getThreadFail(); break;
        case 9: _t->getFrameImg((*reinterpret_cast< cv::Mat*(*)>(_a[1]))); break;
        case 10: _t->AnalyzeThreadEnd((*reinterpret_cast< cv::Mat*(*)>(_a[1]))); break;
        case 11: _t->AnalyzeThreadFail(); break;
